##
## Exploratory Data Analysis - Course Project 2014/08 plot4.R
##
...
# draw plot2
plot(dsShort$Date, dsShort$Voltage, 
     xlab = "datetime", 
     ylab = "Voltage",
     type = 'l') 
...
legend('topright', names(dsShort)[7:9] , 
   lty = 1, col = c('black', 'red', 'blue'), bty ='n', cex =.75, pt.cex = 0.4)

# draw plot4
plot(dsShort$Date, dsShort$Global_reactive_power, 
     xlab = "datetime", 
